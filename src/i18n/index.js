...
export const translations = {
  'zh-CN': {
    ...
    lanServiceHint: '内网直连（局域网端口，不经公网 :44）：',
    lanSubconverterHint: '内网 Subconverter 外部配置（局域网端口）：',
  ...
  'en-US': {
    ...
    lanServiceHint: 'LAN direct (local port, no public :44):',
    lanSubconverterHint: 'LAN Subconverter external config URL:',
